...
def message_handler(update, context):
    ...
    if (msg == "App Development"):
        update.message.reply_text('yes')
    elif(msg=="Web Devlopment"):
        update.message.reply_text('yes')
...
def course(update, context):
    ...
    keyboard = [
        ...
        ["Ethical Hacking"], ["Web Application"], ["Cyber Security"], ["Wifi-Hacking"], ["Computer Networks"],
        ["Video Editing"], ["Chat-gpt"], ["Software Development"], ["Other"]
    ]
    reply_markup = ReplyKeyboardMarkup(keyboard)

    update.message.reply_text("Select one:", reply_markup=reply_markup)
...
def main():
    ...
    text_message_handler = MessageHandler(Filters.text, message_handler)
    ...
    dispatcher.add_handler(CommandHandler("chaman", course))
